...
public class ColeccionCartasFP {
    ...
    public static void main(String[] args) {
        ...
        marvel.pintarMasFuerte(0); //Hay un problema en el que el código no es capaz de identificar si 2 o más cartas tienen la misma fuerza, por lo demás, todo funciona
        //Per fer:
        //Crida a un metode dins Coleccio, que pinti amb un println()
        ...
        int nLegen = marvel.contarCartasLegendarias();
        System.out.println("Número de cartas legendarias en la colección: " + nLegen);
    ...
    public static Coleccion crearColeccionMarvel(){
        ...
        Superheroe ironman = new Superheroe("Ironman", 6, 7);
